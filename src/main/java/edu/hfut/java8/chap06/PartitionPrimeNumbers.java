...
public class PartitionPrimeNumbers {
	...
	public static boolean isPrime(int candidate) {
		return IntStream.rangeClosed(2, candidate - 1).limit((long) Math.floor(Math.sqrt(candidate)) - 1)
	...
	public static class PrimeNumbersCollector implements
		...
		public Supplier<Map<Boolean, List<Integer>>> supplier() {
			...
			return () -> new HashMap<Boolean, List<Integer>>() {
				...
				private static final long serialVersionUID = -4019241590503598204L;
	...
	public Map<Boolean, List<Integer>> partitionPrimesWithInlineCollector(int n) {
		...
		return Stream.iterate(2, i -> i + 1).limit(n).collect(() -> new HashMap<Boolean, List<Integer>>() {
			...
			private static final long serialVersionUID = 4319535585190542564L;
